package saulo.com.sunshine.sync;
...
import saulo.com.sunshine.MainActivity;
import saulo.com.sunshine.R;
import saulo.com.sunshine.Utility;
import saulo.com.sunshine.data.WeatherContract;

import static saulo.com.sunshine.Utility.setLocationStatus;
...
//                    .appendQueryParameter(APPID_PARAM, "245a178c9694509056d37a592a355b5d")
//                    .build();
//
//            URL url = new URL(builtUri.toString());
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS && Utility.isNotificationsEnabled(context)) {
